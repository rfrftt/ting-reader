...
impl WasmRuntime {
    ...
    pub async fn instantiate(
        ...
        // Custom HTTP Host Function
         ...
         // ting_http_request_with_headers(url_ptr, url_len, method_ptr, method_len, headers_ptr, headers_len, body_ptr, body_len) -> handle (>0) or error (<0)
         linker.func_wrap("ting_env", "http_request_with_headers", |mut caller: Caller<'_, PluginState>, url_ptr: i32, url_len: i32, method_ptr: i32, method_len: i32, headers_ptr: i32, headers_len: i32, body_ptr: i32, body_len: i32| -> i32 {
             ...
             handle as i32
         }).map_err(|e| TingError::PluginExecutionError(format!("Failed to define http_request_with_headers: {}", e)))?;
